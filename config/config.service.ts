...
export class ConfigService {
    ...
    // Informações sobre os usuários da aplicação
    ARBI_USER_ID: string;
    ARBI_CLIENT_1_USER_ID: string;
    ARBI_CLIENT_2_USER_ID: string;

    // Credenciais da Parfin
    ...
    // Informações das carteiras dos usuários
    // - Banco Arbi
    ...
    ARBI_CLIENT_1_BACEN_ASSET_ID: string;
    // - Cliente 2 do Banco Arbi
    ARBI_CLIENT_2_WALLET_ADDRESS: string;
    ARBI_CLIENT_2_RT_ASSET_ID: string;
    ARBI_CLIENT_2_BACEN_ASSET_ID: string;
    // - Cliente 3 do Banco Arbi
    ARBI_CLIENT_3_WALLET_ADDRESS: string;
    ARBI_CLIENT_3_RT_ASSET_ID: string;
    ARBI_CLIENT_3_BACEN_ASSET_ID: string;

    // CNPJ8 dos participantes
    STN_CNPJ8: string;
    ...
    // Informações dos TPFts
    TPFT_OPERATION_ID: string;
    LTN_ID: string;
    LFT_ID: string;

    // Endereço dos contratos do piloto
    ...
    REAL_TOKENIZADO_ARBI_ADDRESS: string;
    STR_ADDRESS: string;
    ...
    constructor() {
        ...
        this.ARBI_CLIENT_2_BACEN_ASSET_ID = ensure('ARBI_CLIENT_2_BACEN_ASSET_ID');
        this.ARBI_CLIENT_3_WALLET_ADDRESS = ensure('ARBI_CLIENT_3_WALLET_ADDRESS');
        this.ARBI_CLIENT_3_RT_ASSET_ID = ensure('ARBI_CLIENT_3_RT_ASSET_ID');
        this.ARBI_CLIENT_3_BACEN_ASSET_ID = ensure('ARBI_CLIENT_3_BACEN_ASSET_ID');
        ...
        this.REAL_TOKENIZADO_ARBI_ADDRESS = ensure('REAL_TOKENIZADO_ARBI_ADDRESS');
