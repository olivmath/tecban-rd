...
export class WalletCreateClientSuccessRes {
    @ApiProperty({
        description: 'Key da carteira do cliente registrada no KeyDictionary (keccke256 do cpf)',
        type: String,
    })
    clientKey: string;
    ...
    @ApiProperty({
        description: 'Id da transação de que adiciona o cliente no KeyDictionary',
        type: String,
    })
    parfinTxId: string;
